...
public class AND extends Gate
{
    ...
    public
    AND(final Wire wireA0, final Wire wireA1, final Wire wireB0, final Wire wireB1, final Wire wireZ0, final Wire wireZ1, final SecretKey IV) throws Exception
    {
    ...
    public void createCiphertexts(final Wire wireA0, final Wire wireA1, final Wire wireB0, final Wire wireB1, final Wire wireZ0, final Wire wireZ1, final SecretKey IV) throws Exception
    {
        ...
        this.cipherText1 = CryptoManager.encrypt(Utilities.toByteArray1(wireA0.getEncoding().get(0, AES_128)), IV.getEncoded(), CryptoManager.encrypt(Utilities.toByteArray1(wireB1.getEncoding().get(0, AES_128)), IV.getEncoded(), Utilities.toByteArray1(wireZ0.getEncoding())));
        this.cipherText2 = CryptoManager.encrypt(Utilities.toByteArray1(wireA1.getEncoding().get(0, AES_128)), IV.getEncoded(), CryptoManager.encrypt(Utilities.toByteArray1(wireB0.getEncoding().get(0, AES_128)), IV.getEncoded(), Utilities.toByteArray1(wireZ0.getEncoding())));
        this.cipherText3 = CryptoManager.encrypt(Utilities.toByteArray1(wireA1.getEncoding().get(0, AES_128)), IV.getEncoded(), CryptoManager.encrypt(Utilities.toByteArray1(wireB1.getEncoding().get(0, AES_128)), IV.getEncoded(), Utilities.toByteArray1(wireZ1.getEncoding())));
